...
INSERT INTO star_type (id, name, about, image_url, enabled, create_date, last_update)
  VALUES  (1, "Red Giant", "A low to medium mass star that forms after a star has run out of hydrogen fuel and approaches the end of it's life, causing the star to become bright and large in diameter.", null, 1, "2024-01-06", "2024-01-06"),
          (2, "Yellow Dwarf", "A medium sized star that fuses hydrogen and hellium, with a lifespan of about 10 billion years", null, 1, "2024-01-06", "2024-01-06");
...
INSERT INTO star (id, name, about, image_url, enabled, right_ascension, declination, constellation_id, star_type_id, age_billion_years, lifetime_billion_years, create_date, last_update)
	   VALUES (1, 'Sun', 'Also called "Sol" or "Helios", the Sun is the star at the center of our solar system.', null, 1, null, null, null, 2, 4.5, 10, '2024-01-06', '2024-01-06');
